...
<div class="form-group form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
    <div class="row">
        <div class="col-sm-12">
            {!! Form::label('holiday', 'Holiday:', ['class' => 'control-label']) !!}
            {!! Form::text('holiday',Input::old('holiday'),['class' => 'form-control','placeholder'=>'Holiday Name','required','autofocus', 'title'=>'Enter Holiday Name']) !!}
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            {!! Form::label('status', 'Status:', ['class' => 'control-label']) !!}
            {!! Form::select('status', array(''=>'Select One','1'=>'Active','0'=>'Inactive'),Input::old('status'),['class' => 'form-control','required','title'=>'select status']) !!}
        </div>
    </div>
...
<div class="" style="margin-left:85%">
    ...
    <a href="{{route('gov_holidays')}}" class=" btn btn-default" data-placement="top" data-content="">Close</a>
</div>
