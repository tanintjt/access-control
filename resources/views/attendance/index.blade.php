            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-3">
                            {!! Form::Select('employee_data',$employee_data, @Input::get('employee_data')? Input::get('employee_data') : null,['class' => 'form-control', 'title'=>'select your require "employee name",then click "search" button']) !!}
                        </div>
                        ...
                        <div class="col-sm-3 filter-btn">
                            {!! Form::submit('Search', array('class'=>'btn btn-primary btn-xs pull-left btn-search-height','id'=>'button', 'data-placement'=>'right', 'data-content'=>'type user name or select branch or both in specific field then click search button for required information')) !!}
                        </div>
                    </div>
                    {!! Form::close() !!}
                    <p> &nbsp;</p>
                    ...
                    <div class="table-primary">
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="">
                            ...
                            <tr>
                                ...
                                <th> Employee ID </th>
                                <th> Employee Name </th>
                                <th> Company &nbsp;&nbsp;<span style="color: #A54A7B" class="user-guideline" data-placement="top" data-content="you can change status from update page"></span></th>
                                <th> Entry </th>
                                <th> Exit </th>
                                <th> Duty Time </th>
                                <th> Status </th>
                            ...
                            @if(isset($model))
                                @foreach($model as $values)
                                    <tr class="gradeX">
                                        <td>{{date('Y-m-d', strtotime($values->log_time))}}</td>
                                        <td>{{$values->email}}</td>
